#
#  Be sure to run `pod spec lint MagicCarpetView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.social_media_url   = "http://twitter.com/rockbarato"
  ...
  s.source       = { :git => "https://github.com/rockbarato/MagicCarpetView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MagicCarpetView/MagicCarpetView.{h,m}"
